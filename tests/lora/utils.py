...
def generate_data_for_nslices(
    ...
    lora_indices_tensor = lora_indices_tensor.to(device)
    return PunicaTensors(
        inputs_tensor,        # inputs_tensor: torch.Tensor
        lora_weights_lst,     # lora_weights: Union[torch.Tensor, list[torch.Tensor]]
        our_out_tensor,       # our_out_tensor: torch.Tensor
        ref_out_tensor,       # ref_out_tensor: torch.Tensor
        b_seq_start_loc,      # b_seq_start_loc: torch.Tensor
        lora_indices_tensor,  # prompt_lora_mapping: torch.Tensor
        seq_len_tensor,       # seq_len_tensor: torch.Tensor
        indices,              # token_lora_mapping: torch.Tensor
    )
